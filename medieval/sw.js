const CACHE="hildegarda-medieval-v9";
const A=["./","./index.html","./styles.css?v=9","./app.js?v=9","./manifest.webmanifest?v=7","./santa-hildegarda-icon.svg?v=7","../assets/img/hero.jpg",
