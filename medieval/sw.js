const CACHE="hildegarda-medieval-v6";
const A=["./","./index.html","./styles.css","./app.js","./manifest.webmanifest","./icons/icon-192.png","./icons/icon-512.png","./icons/maskable-512.png","../assets/img/hero.jpg",
